...
Work only in the current Claude worktree and branch:
...
Codex works independently in:

`agent/codex`

Do not modify the Codex worktree.

Do not assume Codex's unmerged changes are available locally.
